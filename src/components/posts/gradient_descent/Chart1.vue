<template>
    <div id="chart1" class="col-md-10 col-lg-10 col-xl-10">
        ...
        <div class="row">
            <div id="chart1-graph" style="height: 22em;" class="col-12 p-0"></div>
        </div>
        <div class="row">
            <div class="col-12 col-md-6 p-1" style="position: relative;">
                ...
                <div id="chart1-bslider" style="position: relative;">
                    <div
                        style="background-color: rgb(80, 80, 80, 0.25);position: absolute; width: 100%; height: 100%; top: 0; left: 0;">
                    </div>
                </div>
            </div>
...
export default {
    ...
    methods: {
        drawChart1 () {
            d3.select("#chart1-graph").selectAll("svg").remove();
            d3.select("#chart1-mslider").selectAll("svg").remove();
            d3.select("#chart1-bslider").selectAll("svg").remove();
